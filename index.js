...
const updatedDistanceInKm = initialVelocityAsKmPerHour + (initialVelocityAsKmPerHour * timeAsSeconds) //calculates new distance
const remainingFuelInKg = fuelBurnRateInKg * timeAsSeconds //calculates remaining fuel
